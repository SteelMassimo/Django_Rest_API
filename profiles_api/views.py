...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        a_viewset = [
            ...
            'Auto maps to URL using Routers',
    ...
    def partial_update(self, resquest, pk=None):
        """Patch objetc"""
...
class RouteSuggestionFeedViewSet(viewsets.ModelViewSet):
    """Handles creating reading and updating feed items"""
    authentication_classes = (TokenAuthentication, )
    serializer_class = serializers.RouteSuggestionItemSerializer
    queryset = models.RouteSuggestion.objects.all()
    permission_classes = (
        permissions.UpdateOwnStatus,
        IsAuthenticatedOrReadOnly,
    )
